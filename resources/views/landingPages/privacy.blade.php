...
@section('content')
    <section class="all">
        <h1 style="color: #5379f6 ;font-family: 'Graduate', 'Cairo'">Privacy Policy</h1>
        ...
        <ul>
            ...
            <li>
                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
                    or &quot;Our&quot; in this Agreement) refers to volkbase.</p>
            </li>
            <li>
            ...
            <li>
                <p><strong>Website</strong> refers to volkbase, accessible from <a href="https://www.volkbase.com/"
                        rel="external nofollow noopener" target="_blank">https://www.volkbase.com/</a></p>
            </li>
            <li>
        ...
        <ul>
            <li>
                <p>By email: info@volkbase.com</p>
            </li>
            <li>
                <p>By visiting this page on our website: <a href="https://www.volkbase.com/contact"
                        rel="external nofollow noopener" target="_blank">https://www.volkbase.com/contact</a></p>
            </li>
            <li>
                <p>By phone number: +967776462030</p>
            </li>
        </ul>
    </section>
@endsection
