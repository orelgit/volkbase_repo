...
@section('content')
    ...
    <div class="d-flex justify-content-between mb-5 mt-4 ">
        <h1 class="h3 text-primary">تحديث فئة</h1>
                    ...
                    <form method="POST" action="{{ route('admin-UpdateCategory-work', $category->c_id) }}">
                        ...
                        <div class="mb-3 ">
                            <div class="col-lg-6 col-md-12">
                                ...
                                <input value="{{ $category->c_name }}" type="text" class="form-control bg-light"
                                    id="title" name="c_name">
                                @error('c_name')
                        ...
                        <div class="mb-3">
                            ...
                            @error('c_note')
                                <h6 class="mt-2 text-danger"> <i class="fas fa-times"></i>{{ $category->c_note }}</h6>
                            @enderror
                        </div>
