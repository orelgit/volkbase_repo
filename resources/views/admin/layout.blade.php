    ...
    <div class="d-flex flex-row-reverse text-right" id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item  ">
                ...
                <div id="collapseTwo" class="collapse text-right " aria-labelledby="headingTwo"
            ...
            <li class="nav-item">
                <a class="nav-link collapsed text-center" href="#" data-toggle="collapse"
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">تخصيص</h6>
                        <a class="collapse-item" href="utilities-color.html">تعديل </a>
                        <a class="collapse-item" href="utilities-color.html">التعليقات</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- N4DA -->
                <nav
                    class="navbar d-flex flex-row-reverse navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav mr-auto ">
                        ...
                        <li class="nav-item  dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-left ml-2 shadow animated--grow-in"
                            ...
                            <div class="dropdown-list  <!--N4--> dropdown-menu dropdown-menu-left ml-2 shadow animated--grow-in"
                                ...
                                <!--N4--> <a class="dropdown-item d-flex flex-row-reverse align-items-center" href="#">
                                    ...
                                    <div>
                                        ...
                                        <!--N4-->
                                        <p class="text-right">تنبيه الإنفاق: لقد لاحظنا إنفاقًا مرتفعًا بشكل غير
                                            عادي لحسابك.</p>
                                    </div>
                                </a>
                                <a class="dropdown-item text-center small text-gray-500" href="#">إظهار كافة
                                    التنبيهات</a>
                            </div>
                        </li>
                        ...
                        <li class=" nav-item dropdown no-arrow mx-1">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-left ml-2 shadow animated--grow-in"
                                ...
                                <!--N4--> <a class="dropdown-item d-flex flex-row-reverse align-items-center" href="#">
                                    ...
                                    <div class="dropdown-list-image ml-3">
                                        <img class="rounded-circle"
                                            src=" {{ asset('images/undraw_profile_2.svg') }}" alt="...">
                                ...
                                <!--N4--> <a class="dropdown-item d-flex flex-row-reverse align-items-center" href="#">
                                    ...
                                    <div class="dropdown-list-image ml-3">
                                        <img class="rounded-circle"
                                            src=" {{ asset('images/undraw_profile_3.svg') }}" alt="...">
                                ...
                                <a class="dropdown-item text-center small text-gray-500" href="#">قراءة المزيد من
                                    الرسائل</a>
                            </div>
                        </li>
            ...
            <div class="modal fade " id="logoutModal" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog " role="document">
                    <div class="modal-content text-right">
                        ...
                        <div class="modal-body">حدد "تسجيل الخروج" أدناه إذا كنت مستعدًا لإنهاء جلستك الحالية.
                        </div>
